...
- **81 exported functions** covering devices, monitors, groups, reports, performance monitors, passive monitors (SnmpTrap, Syslog, WinEvent), and 20 active monitor types

...
function Get-WUGDeviceGroup {
    ...
    # KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBaRLZKD8gHO/em
    # Mf0mWnGWjTG1rMnlI7fLn7uvrVfoJ6CCEfkwggVvMIIEV6ADAgECAhBI/JO0YFWU
    ...
    # BgkqhkiG9w0BCQQxIgQgIhAnJo50vt41hoPEtqYGRkuT74UsCngv/6VaO5KVidEw
    # DQYJKoZIhvcNAQEBBQAEggIAPagP+BBhJXQf53pBXeNUURxXjfos3Fw0lP4Fli7b
    # Y9WZuPpYSRwjni7Z0dPbqn+idTZ4RZXDOdIy76OolkkB474KWVuW39dJWpiSIsgo
    # vy/QcJ7uLp5VQJG42VLyDG7HEVJiv+7YAZn+gknfTf8yQvLM5XJdopXXDDYUPjTc
    # DrzbEaEVfs0oalYNG1wPJV8zahdEp2AoYFkUFzPTVSlRYWzR2HyJSJ6SVLVIaVzr
    # DHfvPxB5ZrFeWfMKCKdXk6hLC180WYAdZbF4JiNsSsCp7iw42r0OFsMbb7wgwMxZ
    # DUE0F0LnmY5oB4hxi3qYQObx8VZjDHSt7X1xRn22ayuSVmHc1JMChFRHqsinw99f
    # /lTr4tnev0FhSbarAn2a1PCz+qUXo1pG1CqqEPUy3RZW3uv3pK/3lW8m2YLothZi
    # vHttdVaXYNNew1fTtXLTJ+jV6PlItZvX4eBJztFVYbiFrERq2pIy+XoT+R+zVjNZ
    # rtvv/hai8sF28ERzJf5z3PmfUgXnqIC3/aJWWDU0Zc36Vu7O4Whoq5FbwDUuiSTF
    # VYFQ12CYmb7zClmLkTWlCdXlzoUlIeeYbMfarCrxyFo2NcELRm88x38qmZpBhQJJ
    # nYC4bpOBklr6hs78PRN5CnnwW4v5aTtTAtT48xiZGspYMo/xGBLV/tThIudDBfv2
    # Av4=
...
# MIIVvgYJKoZIhvcNAQcCoIIVrzCCFasCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDzw/FRyuqh3srk
# rlHhEenQk/ddl8UlstFFPXswGWH9XqCCEfkwggVvMIIEV6ADAgECAhBI/JO0YFWU
# jTanyYqJ1pQWMA0GCSqGSIb3DQEBDAUAMHsxCzAJBgNVBAYTAkdCMRswGQYDVQQI
# DBJHcmVhdGVyIE1hbmNoZXN0ZXIxEDAOBgNVBAcMB1NhbGZvcmQxGjAYBgNVBAoM
# EUNvbW9kbyBDQSBMaW1pdGVkMSEwHwYDVQQDDBhBQUEgQ2VydGlmaWNhdGUgU2Vy
# dmljZXMwHhcNMjEwNTI1MDAwMDAwWhcNMjgxMjMxMjM1OTU5WjBWMQswCQYDVQQG
...
# AWUDBAIBBQCggYQwGAYKKwYBBAGCNwIBDDEKMAigAoAAoQKAADAZBgkqhkiG9w0B
# CQMxDAYKKwYBBAGCNwIBBDAcBgorBgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAv
# BgkqhkiG9w0BCQQxIgQgJwTO6wZl03a/Is+qJ/etJXk5vvvgEiW3ogZc8x8jlbUw
# DQYJKoZIhvcNAQEBBQAEggIAqlgSYydgOvXO4VVQOubAJWUUoor32PLKGILHAhLM
# pJT1PnMJfLDWTQpsuMJJDWx0fYlTjC5O0Ntec7Dcp6yUvy8h2X4ZyXmWglOOQdaE
# e2DjyQ8H1Cyc3uebQXcRsomyMtUDZXUcfhty6ahmVDkvG7MjrwoNqPNUaI9PqfK5
# QK8F0tru1Ocz3HrHe6ehKWmuu89mmlNb104cV7xRBhPYGY2ADekuh/mIdKPEXdSq
# +jACeZxOeIRMqeU6N+RUiKaNQMFeZsg0Ax4idsl/quRdr5kUEUWVIf5YlMNuYQ4r
# BvxPjG4DNoUIkgjT2jbts4UpZ1nNg+Kvxpse0GPbdukjIgiF9fpeoB5yRHTghb0h
# e1lQxPT34EQ02rjngKrmGgY5m3hLv2jeq3lqSXtA+Scca9hwqIkQfDvGVP4SyjOp
# /ljEj5+NHvTsjgCxwLYQwz9yPYjdsjyqoj34v1zU9G/yb/qV4tM5zAuvBwys8jzs
# uPb4C9P+we72m98u1bVPH+8pwCLkPQNrnXaJPKHIttZwe97SwNBE6MfWgJ6YquzF
# ukcDwYHytw4ss4jw3w+8Ych1GvhtqnCdcmg82zcRbGA6GABJlO+jxFzab3EwqfE5
# AzL32UM28sJi8L468bCFMGiJulM5zsXLX6dzdLGb15kI8kuSwvuBhjOv1qWetVOA
# L8g=
# SIG # End signature block

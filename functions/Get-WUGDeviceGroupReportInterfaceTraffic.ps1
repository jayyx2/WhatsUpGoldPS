...
.EXAMPLE
PS> Get-WUGDeviceGroupReportInterfaceTraffic -GroupId @("1", "2") -Range "lastWeek" -SortBy "avgPercent" -SortByDir "desc" -Limit 50
Fetches last week's interface traffic reports for devices within groups with IDs 1 and 2, sorted by average percent in descending order, with a limit of 50 entries per page.

$Cred = Get-Credential
Connect-WUGServer -serverUri 192.168.1.250 -Credential $Cred
$groups = Get-WUGDeviceGroups
Get-WUGDeviceGroupReportInterfaceTraffic -GroupId $groups

.NOTES
Author: Jason Alberino (jason@wug.ninja) 2024-03-31

Reference: https://docs.ipswitch.com/NM/WhatsUpGold2022_1/02_Guides/rest_api/#operation/DeviceGroupReport_DeviceInterfaceTrafficReport
...
function Get-WUGDeviceGroupReportInterfaceTraffic {
    [CmdletBinding()] param (
        [int[]]$GroupId = @(-2),
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCBjzHArzpx/vNN
# 3tC23ssHgHQHV/UbmmbSpw8ZJxeAaKCCEdMwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgFi6tAqtD5gAfrfwSmYLEDqjfh+yrJPJk
# 3BmGmJ7MCN0wDQYJKoZIhvcNAQEBBQAEggIAhp6sVbob8wnkJEppzARVfiqjZKNe
# OQ6A08xmBnWFohQiozQXm88i/8CepcG4qhWvWq9LRhD6sYP86cFCl20hvYk38GBN
# 24K6bGFh/VS/1NFmO4K5BwsET5586K3lmqmw6okQQm2hluVrufBmLGFxisCLczbx
# njvMhY6r1Rv0aQjRoo+aPgyI+3ycfcX3eSw4PFWyGDtsOcTV4YHHf+fjvybnLgTr
# YEwHiiIUZCsWjdE6LhSIaCe+HfUl3rB3rfqjP37laFvaFFSGMtZMyeLAVOuueNeF
# 0ZQR/bwQgw6eoDjOLkOQW1Fj5NisFlIS5VzZLA7yNqWyNbotUWWXb/q/3k1Nj56K
# gd8EpZH3TYHxGbyA0g0IeLKWJpfsPC07TGjxX5PHFVrPwfSgYse+FSTVFKAO2GPG
# fP97+Wyrzd5MsfUMkeGnWNEGtbPeng1Uashy1rHv+zjJ6IoyL5Qn628g0HKRC3LI
# 6ozZVEE+qUJ6FW9b+48LUQDIwCFOLwwotf47YZrZx7wga5YUKMaAe02S8CmDdXbi
# 1whkRl62Ucp5V3Ypx2avS6Gxn+fNBDgJLodFw3lqm57HzTDBHfnlu6jwZvhPPJ+a
# mmM3sXTeloWtlaRPzeR23fpQK5nuuEEolJx9hvskQZd5EH4w7ikUMjz/ztcG1roO
# v17/I9WEH/FGZ1k=

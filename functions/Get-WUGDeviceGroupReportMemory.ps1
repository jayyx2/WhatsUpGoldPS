...
.EXAMPLE
PS> Get-WUGDeviceGroupReportMemory -GroupId @("1", "2") -Range "lastWeek" -SortBy "avgPercent" -SortByDir "desc" -Limit 50
Fetches last week's memory utilization reports for devices within groups with IDs 1 and 2, sorted by average percent in descending order, with a limit of 50 entries per page.

$Cred = Get-Credential
Connect-WUGServer -serverUri 192.168.1.250 -Credential $Cred
$groups = Get-WUGDeviceGroups
Get-WUGDeviceGroupReportMemory -GroupId $groups

.NOTES
Author: Jason Alberino (jason@wug.ninja) 2024-03-31

Reference: https://docs.ipswitch.com/NM/WhatsUpGold2022_1/02_Guides/rest_api/#operation/DeviceGroupReport_DeviceMemoryUtilizationReport
...
function Get-WUGDeviceGroupReportMemory {
    [CmdletBinding()] param (
        [int[]]$GroupId,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDbY1yrn4U+JHHc
# e7lpFfwO96baIl/xbd2GDXIGqSbvYKCCEdMwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgjMPmhOYq3Gj+mMU7iMYKaJtCTArVLPkO
# H0GbAE7jMVUwDQYJKoZIhvcNAQEBBQAEggIABaBEU5sUZd8hp02m/QLxyaRbP+8o
# 6Qre7oqOYmteUwi2J2N7CHEpgsqbGLV9iWuR9/InJgENnGckt2AdmDITqqcIjzJc
# hKB8Ucr9ft0eCo2YCHF41SKWVpPlzCn9rpide75p5vTJuhKitu64WzPo+hxBj2qv
# H52pygdfuFZMbreiMX9NnZdNzijxRLH16vDhy4RBL3sL0JLywyIBMgKRspwc2PEo
# ovQO6pyZRXWNQTz+PUUN2QtIcAP1Yp15z3Yz5Pvp1bO3MxBTzLwHwXrC3onCeHMC
# Hnhk8K+v3s2jfybH6h7YYEKNec5v9j3XHs7nuw456Geh1ZihNhY/9HVPlt15a/x0
# 43ju9u9ugIPEwjiWrytYCsofa5sTTFiduq5PCw9JATWPUSgrVmTgjEaSpqjKMUmR
# t77PLJeSPL2k8FF+7I7yxHHcuYjce6Bm+W5JVtvu0X4lAROsfGvUiyE+UGDmos8a
# K0FOZW+dMPCJ8HB0ymnHYEXlEirulrCT6xin+hHX9rnwCstmorQPECRd57s9Ef1h
# vxSYO7JBypE993R5UnIWVBNB2pAxk+V0vJBgGGUyk3aUxgJ5rdjGQAKm0/dZ2+2o
# aovkXSTSB1TXkrp4L/xyS5pkPhB9zl0FtEvyv1Bank1Ty9a911/SsSqTjsLyVeJV
# F21mhp/dHde+M70=

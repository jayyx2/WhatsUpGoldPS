<#
.SYNOPSIS
Retrieves Interface errors report for specified devices from WhatsUp Gold.

.DESCRIPTION
The Get-WUGDeviceReportInterfaceErrors function fetches Interface errors reports for a list of device IDs from WhatsUp Gold. It supports filtering by time range, sorting, grouping, applying thresholds, and automatically handles pagination. The function provides progress feedback during execution.

.PARAMETER DeviceId
An array of device IDs for which Interface errors reports are requested. This parameter is mandatory and accepts multiple values.
...
.EXAMPLE
PS> Get-WUGDeviceReportInterfaceErrors -DeviceId @("1", "2", "3") -Range "lastWeek"

Fetches last week's Interface error reports for devices with IDs 1, 2, and 3.

.EXAMPLE
PS> Get-WUGDeviceReportInterfaceErrors -DeviceId @("4") -Range "custom" -RangeStartUtc "2023-01-01T00:00:00Z" -RangeEndUtc "2023-01-07T23:59:59Z"

Fetches Interface error reports for device 4 for the first week of January 2023.

.NOTES
Author: Jason Alberino (jason@wug.ninja) 2024-03-24
Modified: 2024-03-29

Reference: https://docs.ipswitch.com/NM/WhatsUpGold2022_1/02_Guides/rest_api/#operation/DeviceReport_DeviceInterfaceErrorsReport
Provides an interface to WhatsUp Gold's REST API for fetching detailed interface error reports across devices, with support for extensive filtering and pagination.
#>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBnjOk+qCWjvubd
# tcwfKKL1VZx97HA+ZKJV4dd7z9gleqCCEfkwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# BgkqhkiG9w0BCQQxIgQg5bjfVSZH3s3zixxWpRL/XiXOIvLYG+oyGCZ1EwvJRscw
# DQYJKoZIhvcNAQEBBQAEggIASJB7YxSi9D5t4hu6Xx8jx9ZvDSRQ2cRUXJ26aXZA
# D/i1yF9LBpMbf0oFNS38PSs6byly42d+Rhvgtag/iBtDNjKXHtVfijTPt9KktZn6
# coJh98g+jctlmWzbUp+5t+DOvK0ym41gjPjs7+WXa5cX0azyCTAncOcN6H6yBKzr
# ePp7u91IJmpYPSjc21sizy0ksEzD2RN476iJQUu26ESFBsIc+L1xCQhYVIRF1cpo
# rxsZVTynIc9NRe/uN8SOWhmbI2ptkzxEqyc8hjOQ8thCj9ftx2UwQncEsSEqvMT5
# Yg/iyrSA8Ls+G/AcW/WOQCYJYSwhrxOG/DBX+6JhvMBV99z89J+DVZoIilPce53n
# XDxRRkkUrmJcebpYJifjAjSo+h9truzLBzeDaJ54gjjcZLa0sv59m29Cy5iNgYF9
# wu5tZ8ldzxkriwRgCLtCEzm8C6WdYD5DAlZIGNtC/ZVDIqAq6KltUMuiF/F1XTHo
# dHmg7dqwSzsgdq9j3E2p0R3PCwyR732LiHa2w/Qg7tauRMpg4Pm+jLknFgaVMaoE
# fGvQyfhQzINC7pZDc3CbDdd9k3Vb/K0RuTHnAYBLqOsVTqb4iIjiWjR4C3yYJ5cE
# Zc/ye9ld/FwsV8mjyAbxWS7C1QW1Sa85MbnNh3iF3H/7IohzzuI2XWnk51JUWS1C
# MYk=

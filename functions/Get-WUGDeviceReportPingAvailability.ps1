...
function Get-WUGDeviceReportPingAvailability {
    ...
    begin {
        ...
        Write-Debug "Function: Get-WUGDeviceReportPingAvailability -- DeviceId:${DeviceId} Range:${Range} RangeStartUtc:${RangeStartUtc} RangeEndUtc:${RangeEndUtc} RangeN:${RangeN} SortBy:${SortBy} SortByDir:${SortByDir} GroupBy:${GroupBy} GroupByDir:${GroupByDir} BusinessHoursId:${BusinessHoursId} RollupByDevice:${RollupByDevice} PageId:${PageId} Limit:${Limit} availableApplyThreshold:${availableApplyThreshold} availableOverThreshold:${availableOverThreshold} percentageAvailableThresholdValue:${percentageAvailableThresholdValue} packetLossApplyThreshold:${packetLossApplyThreshold} packetLossOverThreshold:${packetLossOverThreshold} packetLossPercentageThresholdValue:${packetLossPercentageThresholdValue}"
        ...
        if ($availableApplyThreshold) { $queryString += "availableApplyThreshold=$availableApplyThreshold&" }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUPtmZaI4CIfPJxk6apUDrfkL4
# kaKgghH5MIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# DAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQU47kyYpxPnGBQ6yv7bXWtS/WC
# k8UwDQYJKoZIhvcNAQEBBQAEggIAUd0KzZgvKfuMVdsvhJkyfzBIbKPINKNShB/Z
# ENKjXSb+Qvl4RWGFSznu0qcZwRItgcxo1bBDfK4FicQBICzb5RfsozkiT9qG1fxu
# 618MeYxJ0AGibHUTSLYt1JBBg3jQuhZ1nmmf6BOcPcvHYjCtbG6VOnCer/gUFUWw
# 9Ff58ZUEuT69METwuaUby/IyWK/HZbSfrFnGFOvDbfhegV8Erjv4K2tH1OosIMXx
# WR9npBxUzq1hRULqInyFtDPkSz6UR6F9yoQHO3h/wR9Gz3JwVr1oZi1rAummKG91
# wslfoobHXCLyT/s9wcaax4+VZ/Fx4J1WuX9gXR5XHY98PheZZInQHNLfe8sFpKmv
# r/8knfh1nP3BtWVXETRWzzemaZ77kKIMT0hg5ltQt+cbTx787vjTz9zHW2NGC+4f
# PSmK/4EDr7cF/dHah4ebGYtJIlbvVdfpwUbedRgiIQ4pMR3rNolEiMAniLx2+ynR
# ELFUZhxqTNEzdLYsFjH4vPg5PJJYSGO+ehPRXEfecHjkhVN4xblmCLIrIgjBFqdR
# cQWlIDL525aDvfJI1E1m5jSEKue+9XMzmu3WguvmLEpgdeI8t5yA5BXyeuL+XRiE
# pA+Na+dZLOTs0Ii0Sv3GjPsIGdItx5XmglcMpi7yo8/UJZTeJ2j+46dG/VtFGfrO
# nmY7WgY=

<#
.SYNOPSIS
Removes one or more devices from a WhatsUp Gold device group, or removes all devices.
...
.PARAMETER DeviceId
One or more device IDs to remove from the group. Mutually exclusive with -All.

.PARAMETER All
Switch to remove all devices from the group. Mutually exclusive with DeviceId.

.EXAMPLE
Remove-WUGDeviceGroupMember -GroupId 101 -DeviceId 1, 2, 3
    ...
    process {
        ...
        if ($PSCmdlet.ParameterSetName -eq 'All') {
            ...
            try {
                ...
                Write-Error "Error removing all devices from group ${GroupId}: $_"
            }
        }
        else {
        ...
        Write-Debug "Completed Remove-WUGDeviceGroupMember function."
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBQTCFEmuzSoIpH
# d0t0cAWJxmkQVphrWPS3AXjv8Q3mg6CCEdMwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgEvCq8/51ew/wtT0AZvAtA4Q49VEZ3l6O
# H9oO1Na+2p8wDQYJKoZIhvcNAQEBBQAEggIAwmrDDT9Ttlw7evElbT/NUL1tFSEx
# /PYn47SzDilesZyzggHIDayK5vSoHMv5h6hTuZYqtVn0Xl+2SwVtiUYSArjIIbbg
# hknqkxAM2KtpQ8Jc/gydzucWgW2kU6Faa36TFc5vOUwBN1HD0XxSe00dHb3tbXkA
# 7kciwF/punuoTBTMv0LTqzWwHpNq82WLQArePnokUH2jiiSCkzgurq1aWW6uCH5U
# qHLwqf4QWuJKfiy4NN8/wuWQuyHx1/+CAXCgWMdoU6Ib5sNtyhmUk/2pz/A7Dw22
# wMRPaiglq1VFYefG3Kiw/czyYorh5qDwdqs1sdLFLzU3KblkXvvEAvTEpH0SJ95V
# gWje9h9/MOydkzja91iolc2Jh+xoSmCRtvTbyam/AxRFjJTEl5W7HyV1/NbcmUlc
# DnF4yCySdFc8wYKrOwlk13vhEogK+BPXXNzQ6ssGqzjICP0lRudi+R9MJIWN1q4T
# 4rCbpR2Yu6XGCA53s0BVa8VLWUPA/hchb3McZNLxZAJVUoc5XtAQMOJvKtOHacSF
# HhyUgdcLZNTqsIDz3VoB9r33wIblkZAoKOd76rRloFFggyvc3UlEyCIQey6kLc4h
# Sdrt37TYGr/v/zGCcyDWKiuEvB3Cydjqe3GtZcWt68S/W2wWjIXB3U0TrmZy1/xT
# JiLtIIjtLSEVhBI=

...
[CmdletBinding()]
param(
    [string]$SummaryDirectory = 'C:\temp\wireless-summary',
    [string]$OutputDirectory = 'C:\temp\wireless-summary\dashboards',
    [string]$FullDirectory = '',
    [string]$WhatsUpGoldPsRepoPath = 'T:\OneDrive\GitHub\WhatsUpGoldPS',
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUW9zxEb4IOhohSe04FhOaOR+l
# d0iggiUNMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# AQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFEh+KgeT0r+1Doiuq+bYzdGznksPMA0G
# CSqGSIb3DQEBAQUABIICAINYgOSge04nbLKTI79sSFGBnD9MS6AKTA0x2K4K8YgJ
# ilnIAOy/0HS207fxOTsdcaWxj4d9ZPbFv5xt3kNcyrlzKpazG2nDGtddGEclw3l4
# YSN6X71HSNReWehStVE+pZj/75aZw5mo6ctip1Ka9IvADn6ivXaSmgXuM0BaGAaN
# /Jlm3O+Pf48TTNlkvD0s/qIuEhgKF/6/VEfAKl/MrdKLhZfwmridZW6TmKV/Olh6
# eRF6zbc5WRe385x1GYVXnkHkfCm37L0m3YHRDqQOPCN2KY+5j2ZI9RmxSIOcsADE
# CGub2CSW7rNV8sHaxv5Buhiu5z/aOkyxl+I9QUy7r3BouXKZCg37/OIQLKOAX324
# OlfpnLQHPsQJXVF0NH3TYY3EX96sZzUkQDPTe8dvm5ovS1JChZue4kSbJtpTW0IP
# tORFKxjZ/TSSvqhVv7Xdns4CzrDnHJwu5vM6lMrFlqpWKvE05yL41hjpRWUDWuXc
# dldKPLQf1xQM3l4nQ/RkfEYUotNE24kl8Wh/wpjESyernQakopaFHYS6Ij+8TeMD
# YHAFN8/DFK7P4K6YNwLBRpIRcGGTfzQFoPib83FgRbqjtMTgeB0C8KkvwLTlHj+a
# /uQqAq3yOtsyNJxm/+hHUHugwv2OJnEqP5iSW58jMxA2W9KlCLd2w9WjFHNRXoNv
...
# hkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI2MDYyMzEyNTYwOVowLwYJKoZIhvcN
# AQkEMSIEIByuemlJ6ML82PfX4mqUBfGLEzNwKlF9M2iy0LjjQOajMA0GCSqGSIb3
# DQEBAQUABIICABnGRmam7vJdJ7HkuLdaLozMjOOLbCBW4Eiq8cskHqmCUX0BKJJ0
# cAX6Uiu3j5c4ABPsCfM3Dnv1fE2XvaP+uVslzYzVoHaTq2OsFEWdr7DA3EY7tdIm
# pwNuO6mGzxlBxQjufgKcZEUa+uPJVRUHWAkGMecx8oJFQA60V12iLuqpjdwTS7QW
# gnotmsfUkcRQQ42IWfhynbRBleJH2WCz3dnWHQb+AE82MN8RLSJ3dOdy1nnCGyLj
# rOcuP6Kfp4CfYisDfShbw13TXPbkK68pufRcCR8nhuZfKj1ykfIr3svG14I9xCoP
# BLIXkHwOEMClEWTymWQr/skWkyYl2BdWv0RtNlCwmdOxtjODM0LWzKsqa9IQQgvD
# dZh/e00ArvxZh7/nTr2IBqmvOwM76935C3Zf5USW5vj6TCuZm5muN3MVV5wcp2bg
# QYClktbdlBcw2RhO3t43hn/Iieq9tNUiLICRc4kVv5E/fhKY+fift1Ux5sTuP3oU
# Nnt5qvmMFbcLeYOUO3EPSs5C98yP5nO80RAnbntXG8ySEu/Aukoe8bSjU4H6cZMt
# Atek/+x5ofTuM3KMkHyCD47qdym0b9QkcNTK1jc5Y7dq6NaG2vNIsDA5SjLfIQgr
# ClUBZ3TSWhYjyYlImN7IEZPEIzb+mSWcVPnfACKT8ZfSGB7FLuQggDyk

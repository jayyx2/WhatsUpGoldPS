    ...
    '5' {
        ...
        if ($dashboardRows.Count -eq 0) {
            ...
            if ($nmConsolePath) {
                ...
                $wugDashPath = Join-Path $wugDashDir 'Bigleaf-Dashboard.html'
                try {
                    Copy-Item -Path $dashPath -Destination $wugDashPath -Force
                    Write-Host "Copied to WUG: $wugDashPath" -ForegroundColor Green
                    Write-Host "  Access via WUG web UI: /NmConsole/dashboards/Bigleaf-Dashboard.html" -ForegroundColor Cyan
                }
                catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCGgQLod07GeFxc
# KLkOtREdOF0yK5ydWxCcNzskjmmv46CCJNcwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCUcg2H
# oyfz81QHLefnhO2y4XqPnU0qP8s45tDYgDqpRjANBgkqhkiG9w0BAQEFAASCAgCu
# oX8pLnadwarIvkdy7R7YRIJ8RtX4G2hKG2+hEoTVzalZ3ThzCfpaOqHj/WgaOKh9
# ACfTHnm12PbyHOqBgScZ2f0JswtthrQFIJLduOEdybWsmyxFGLrd2fO4sbHEinSP
# h3K06MCjJZ77t5MzcA+trA4MEKJqAKxx8hEKOQQsCrr43OlkMVerNOjjOtlxtyi7
# 92uNPmaLWayw1QaZDBmwwWldrSldMvfcQO4C92B4X3YTAs6hhVon7DLT9t6IXCJG
# AxA8B2wS+6C+ZZrLr506gp8h4j/uL0M4tMpdz5MECGKjihxygSF4tJoysWs/dTf+
# z72hJmlADQp9fzIheFOxQ+lOz/fqg4Zab+du5HvXEfRB2Zro59r5perHsHGiEfzf
# vwheiS+bauyi1dh/NORdA+b/n/K7z1G2tXqT2zaMM8ES9ZahNeoTQVHEa7b5EZDZ
# F5q+zzNSm1/OgOwIaIujzhJxxZkvcXxq7HV3aXqxV9ZUCtrORemaMmpGk8yAjzvT
# kEC44LAE0EyD+/ZmfkyX4T35FjEr4RKWORc4yRHO7zX0MIKDZ/rMHQwIROEwkEFN
# HM6ai90oKSBTL2lGThw3AuVNLNjWpsI6JLovjKX88iaZv6sGtMPCePsK5klshmIA
# aRs9VYSW+a/qY6/7joiOf+qcmKsQU5PnMer12UE04qGCAyMwggMfBgkqhkiG9w0B
...
# NVowPwYJKoZIhvcNAQkEMTIEMHEmLOCdX5gNCLNPySkeei2+nSpP6kbiQYXTwCLN
# Qmo2kcYbsOyjLkj8X1aAYapO+zANBgkqhkiG9w0BAQEFAASCAgA8eNfVwfEWJ//7
# FBISGwNHu9ooJoLPqnT1/5xNp0BVigsnKlGntgY3xgcv2u9AnpkFZReg+wyOJUlE
# YFqZw/myseCYrBP3HDdLD0Ikh3KAmwpMvb0W0qIr3jX3SZ6FbZJeVef5y8RBtU+9
# qjMEd6WZuMKRMxlt3QRzi+ZJ7dy5EFsdce7rAiiG7iTV71sAbgXJRiswQs2lFQTV
# oIIj8lSNpcjCFxbTQKRQG2wy0BTpXkhG2Az/bOezWIEu2Rm9wjciuNNKvi9Mn5Pu
# Y9nGg5VVwZMYQCaNUnjqsIhN3DG5sMR9NkFUrICSPcSwZ9UY2UrvflORbdG4sLfa
# ubp9POmCPucS87PhpgnfPYEXVDMHH59rRx2PCzpU7GL1vuIr0CT8dcvuIdnFHK/G
# 9Z4i7uz6EmqwDvatA/QcTjXtbpWNt+ZkyptF2bJEeaaZvXhuLsIWIjB2U8ud/gDw
# benkjiRbI3XZqemH8gQ8bIKnIwC9xg+S1FvpB0NyCkPWNOuIcaLhloWYyLchirpH
# a4GM6K5GzcIP810+3VdAG5NnpyHjAo/w9uqPtR+s1RjMwcriy9/AqmUlz5yWrkqm
# iuit6rRGyAH4Zkl02jVYQBMGKErM5TNxVvNZlmM13qGdE21PnQgTOmuirUTd+MpU
# H4JbC4z63IVgoPAWw7HCEFm+iZTmKg==

...
switch ($currentChoice) {
    ...
    '5' {
        ...
        $dashPath = Join-Path $OutputDir "LoadMaster-Dashboard.html"
        ...
        if ($nmConsolePath) {
            ...
            $wugDashPath = Join-Path $wugDashDir 'LoadMaster-Dashboard.html'
            try {
                Copy-Item -Path $dashPath -Destination $wugDashPath -Force
                Write-Host "  Copied to WUG: $wugDashPath" -ForegroundColor Green
                Write-Host "  Access via WUG web UI: /NmConsole/dashboards/LoadMaster-Dashboard.html" -ForegroundColor Cyan
            }
            catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBOGWnatDXulIFc
# FtshQj/Eu/Ue7quCa/EC10t/e2GmZaCCJQ0wggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# BCCcca5ZsgTzAyXqbkDa+ioHrkx8/A9sPeI/dn03gM8pZjANBgkqhkiG9w0BAQEF
# AASCAgAHvMCTmSuwRLD3hqPr4Xi5XvnABmlLiXVi/mEifnjoEbX5JbmVkLW+b2UO
# DREojNUT6lqQxWduDyuRs+tRg/73BNjoxvedy4XU5sTiGXySz7Fo3VB9rMdZ6IpY
# wW0GEMAOMFd/eaI+2X79OoCyXUuYXF/zdtJcX09SD4ptfYa9YbpemqhIih1UHOBt
# qsgwvys2QbcZjDkQ1H34Gq3zOuZhzJ/61g19JLey2c69eYh0K9+OOCpEsyJJYZn+
# iPv1pfK9k0uyJaJ0MAs2rfysmdhJ0umyhci/zsLNQObqVwq1tMIMmuHNTK7y+mq3
# 4HLIxh3TIzKLsggBVRmbOo/9A0/1UD+UBZ5repGtwtwJEAkECLZTQQw++KFP17WW
# gXLTzkB821/FhJ8ygkbBAiTk9iM87cGH/5bSVEVfqsMFN5Q61Gbe/eTkgvPpTqDZ
# lCoBtW4tMHgMDXj1wATalcrF3IZDYWRlj9H62tAgpousMI0zTGEs5LvZWYN3dndq
# xih65nt1sEOM9zG7SXdLWz9xWtCvIYhRQj4AfbNzLiBmRBDBz+plQ2/c8INNg+9n
# purwaMWfoh3nsYRTj8j6Kkbj6Asb2vMzBbIskf24rb3hN+P+2SKKwmUvGlw939LN
# nJKePbhG0QUYihTKd+r7OzSP1gCwwfKojxuSDw8e6apLNXJi1KGCAyYwggMiBgkq
# hkiG9w0BCQYxggMTMIIDDwIBATB9MGkxCzAJBgNVBAYTAlVTMRcwFQYDVQQKEw5E
# aWdpQ2VydCwgSW5jLjFBMD8GA1UEAxM4RGlnaUNlcnQgVHJ1c3RlZCBHNCBUaW1l
# U3RhbXBpbmcgUlNBNDA5NiBTSEEyNTYgMjAyNSBDQTECEAqA7xhLjfEFgtHEdqeV
# dGgwDQYJYIZIAWUDBAIBBQCgaTAYBgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwG
# CSqGSIb3DQEJBTEPFw0yNjA3MDcwMjI1MzJaMC8GCSqGSIb3DQEJBDEiBCDtMJHL
# eNd38WIHljKatL/rcktAgHiBMiDA7YmZg1Op2zANBgkqhkiG9w0BAQEFAASCAgBG
# 5+OuXuxmYclw9Qf2pWbH0yQ/f7LDi/6Ap56LQRWHH8PAlDM+Mf3yXayUWc/G0tK+
# DC5psZcwBdTVD+LyL6kGxc4o0lr58SVVKcPi5m4Zd2Sl7vbMp7A06ggFeSLYh34y
# ZQ8XmRrPF4wek8+vh/+9BO6nUq8p+D9IljOQb0Zb0kmZP+uCiOW2psjrWipVd0bM
# j5bC9YE0mOy+4jwlwv6WHCsDmG7sJ60rNaqyuAo0BQNsvg+80zZiOFqoYmKM1OJX
# SEVv8+fg2XW5N9g8Hc82ntRmHZWwa17Q1PDyHhqTY7LjS9Ajx3R4zXJ7MkT2aNJS
# O/GMeifvZIk0e3Q2PzWS9S/O4KDjNyG8aXgUgHyfgCC3eJH8cCVCM8c5jCUuYasl
# ukscjw3bHwvJOIKYPQO9qlRECgeIypVMv+V37VFelMbav1OX795pN2yR4Rp0O6LI
# gVBN53TzI6Yfzpj28AWfih7u2nvx0ZvkyF3n1Ggz7fBkdAyF0srbVgIO9PQmp1OX
# j/h6bChJKO5jrEeD8HuEzrGjrPxyqO1QPvo1wp+MA2+JD+cnfm0hjn23ZOYm872B
# Hf3j7kXcSDMNa7cDREeSN6tG+FXqqXTbjRUBXkUjoNqEKfC1ODRHLPXUoJSqLkAv
# F0YYGf+sXtv/OjR3BQU6+dwwNGk0dGJ4Xv1ja9ZDvA==

...
.PARAMETER OutputPath
    ...
    Default: Geolocation-Dashboard.html in the DiscoveryHelpers output directory.
.PARAMETER OpenBrowser
    Automatically open the generated HTML map in the default browser.
.PARAMETER SkipNmConsoleCopy
    Do not copy the generated dashboard to the WUG NmConsole\dashboards
    directory. By default the script attempts the copy if the NmConsole
...
param(
    [string]$OutputPath,
    [switch]$OpenBrowser,
    [switch]$SkipNmConsoleCopy
)

# ----- Resolve paths -----
$scriptDir = Split-Path $MyInvocation.MyCommand.Path -Parent
if (-not $OutputPath) {
    $defaultOutputDir = Join-Path $env:LOCALAPPDATA 'WhatsUpGoldPS\DiscoveryHelpers\Output'
    if (-not (Test-Path $defaultOutputDir)) { New-Item -ItemType Directory -Path $defaultOutputDir -Force | Out-Null }
    $OutputPath = Join-Path $defaultOutputDir 'Geolocation-Dashboard.html'
}
...
# ----- Copy to NmConsole\dashboards -----
if (-not $SkipNmConsoleCopy) {
    $nmConsolePaths = @(
    ...
    if ($nmConsolePath) {
        ...
        $wugDashPath = Join-Path $wugDashDir 'Geolocation-Dashboard.html'
        try {
            Copy-Item -Path $OutputPath -Destination $wugDashPath -Force
            Write-Host "Copied to WUG: $wugDashPath" -ForegroundColor Green
            Write-Host "  Access via WUG web UI: /NmConsole/dashboards/Geolocation-Dashboard.html" -ForegroundColor Cyan
        }
        catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBEVgSZI7Vd6sNC
# RwzMR2HM/zdDPoc31v5gna99kKOQGqCCJQ0wggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# BCA+xLvFWxPLIkIKXK+vmIcVHfvTG6pwnmtLi57cQYT9BDANBgkqhkiG9w0BAQEF
# AASCAgCaLu+riXg405tkIVq3KKNl31OQklOnWs51PzlvmYaOV/GkS+JnyEV6kxbU
# ZVtkUMbFAGPRa1gk9C7nNc+ve1HxtL2xvOlI3iOBkR4iq/WaSU06fzvUe1ngpMM6
# 4nvhw42Gs9M6vki4Xy3ExuQjqPdcK5DSMwyeKt3o+k7AgfOXhEDlQp+3CLSXqVRb
# UXO46MyN7vZEwyhBZNebdQ2OibtNyTUxFUAuNQ8GvNeFOJBVetBkI0HvdLfUjZ+G
# XmOfHKpXSSMeN7Ae/2HXYkwjZHyiP8BF6UYKiURZsaEzULyU4TA/vXdj0cgBZmHF
# arnbPQ5DWny0/ozc6Pk107EgyNV/01sQEe+lo4s0X/agrPAKJagsKlJxC14KpomM
# DVfISCUmdyRRx5iR03Jz4Fc/IMmgx6uWUhHUibVG/bq7+WffV3r+OEiGCv8WWyCk
# Qr7kQR4QVGM3odn89FSdipLOsFYw4nw4i+4IUQbkxs4zqGYWn6o1r1rmPbnde6aP
# c74BOWYTkA4vcRA+yBS5lKL1X/Iru3hMSv6opepm5DHcWh7fD/YCXZnjfiiYCB4g
# 4PCFY5tiMNCnA+DEqmto6syhQR4bzCIoFgExpytLVrJv1yLPGn96RsspOfd/PgXf
# uADE/tzoz+/tEoRXL3geojj4A7ZCjggaa+X/ILE92KNtfdLuNKGCAyYwggMiBgkq
# hkiG9w0BCQYxggMTMIIDDwIBATB9MGkxCzAJBgNVBAYTAlVTMRcwFQYDVQQKEw5E
# aWdpQ2VydCwgSW5jLjFBMD8GA1UEAxM4RGlnaUNlcnQgVHJ1c3RlZCBHNCBUaW1l
# U3RhbXBpbmcgUlNBNDA5NiBTSEEyNTYgMjAyNSBDQTECEAqA7xhLjfEFgtHEdqeV
# dGgwDQYJYIZIAWUDBAIBBQCgaTAYBgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwG
# CSqGSIb3DQEJBTEPFw0yNjA0MDYxOTMzNTFaMC8GCSqGSIb3DQEJBDEiBCBqxmaB
# TFeiPlM9xaNQh4vrGoa62LoaE8oL+9pLmzjCgTANBgkqhkiG9w0BAQEFAASCAgAq
# IUy5AK4U5qYxn39aJuCJe7n8XBG8pEdmHcDMw7Au4NCqSnhgpofm3hsM7+6UKVqz
# DKXpsWTR02UgdLhVpkL39fDVA+BcxL4x6Y+2QUnfmS8SN+scV7plLJaKWWCXG3fk
# tLdLLk9v2YTMkUfYHR2rXWsRjXMw9cebkU30P4vPSh3sXqU2uwi1kpJgQxmue919
# 7ScS802Na2GFamsPlUxoVR6bg4GzO4Z7hCghzDfrzx25GkvRRVo74S8zpDYnGkQe
# F8CctGTV11Q9p7n5fmwAhAT9iRD/96E6YRTVGsectA4dJKnEirSyWqYVsRLhtLr6
# p7Yj1Ja0pU17/8DPVQMUmU9Cd4NiSRoaRUq8AMqxXjbvcHhvZEHm2ESObCwWaboy
# r/fAsi+8xLJ6RaSZTDtpmJmMKuVF4lR+9hV14kS/OiWfezmXi3xFN+vwWRd0Kj+L
# TYTLbpSenV/QwsNTzZD9k2dK0J5+Y3RpNopFroTzrr0U6bZl2x7DO8yEMvDoKeGZ
# GQh6NUyboc1Fz+OSWI6LQ0NgGhvUGRPW+WTJ43lix1qzkDUY8arFWxbfNvX9ZRLf
# zDHBXEz9WZjyCDZaTBKzaFrVD6EIIgLBVE+ZJIIi4NH4m1R2Kw1OAv9KMGzSy8My
# KAKfxYdK04r4ouOGokfZXvWuHw0irBIQuMiBS5V0Ig==
